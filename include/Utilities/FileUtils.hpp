...
namespace MultiplayerChat::Utilities {
    struct FileUtils {
        ...
        static bool GetFilesInFolderPath(std::string_view extension, std::string_view folderPath, std::vector<std::string>& out);
        ...
        static std::string_view GetFileName(std::string_view path, bool removeExtension = false);
