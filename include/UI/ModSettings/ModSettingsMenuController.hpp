...
DECLARE_CLASS_CODEGEN_INTERFACES(MultiplayerChat::UI::ModSettings, ModSettingsMenuController, System::Object, std::vector<Il2CppClass*>({ classof(Zenject::IInitializable*), classof(System::IDisposable*)}),
