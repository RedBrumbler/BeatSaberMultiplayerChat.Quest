...
#define AUTO_INSTALL_PATCH(name_) \
    struct Auto_Patch_##name_ {                                                 \
        Auto_Patch_##name_() {                                                  \
            ::MultiplayerChat::Hooking::AddInstallFunc(Patch_##name_);          \
        }                                                                       \
    };                                                                          \
...
#define HOOK_AUTO_INSTALL_ORIG(name_)                                                                       \
    struct Auto_Hook_##name_ {                                                                              \
        ...
        Auto_Hook_##name_() { ::MultiplayerChat::Hooking::AddInstallFunc(Auto_Hook_##name_##_Install); }    \
    };                                                                                                      \
...
#define MAKE_AUTO_HOOK_MATCH(name_, mPtr, retval, ...)                                                                                              \
    ...
    {                                                                                                                                               \
        ...
        static_assert(MultiplayerChat::match_hookable<mPtr>);                                                                                       \
